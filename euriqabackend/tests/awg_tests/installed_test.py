...
if __name__ == "__main__":
    ...
    seq_array = [
        [
            ...
            pt.phase_advance_sine(1, f_test, 0, 9.82),
            pt.sine(1, f_test, 0, 9),
            pt.sine(1, f_test + monitor_detuning, 0, 500),
        ],
        [
            pt.sine(
                0.4,
        ...
        [
            ...
            pt.phase_advance_sine(1, f_test, 0, 17.15643),
        ],
        [pt.sine(0.8, f_test, 0, 6.72), pt.phase_advance_sine(1, f_test, 0, 9.99)],
        [pt.sine(1.0, f_test, 0, 8.354), pt.phase_advance_sine(1, f_test, 0, 9.26578)],
    ]

    slot_array = [[15, 16, 0, 0], [15, 16], [15, 16], [15, 16], [15, 16]]
