...
class BitfileInfo(object):
    ...
    def __str__(self):
        ...
        return "Device: {0} Creation Date: {1} {2} Digest: {3}".format(
            self.targetDevice.decode("ASCII"),
...
if __name__ == "__main__":
    bitfileinfo = BitfileInfo(
        r"C:\Users\pmaunz\Documents\Programming\aaAQC_FPGA\FPGA_Ions\fpgafirmware.bit"
    )
