...
phi_SK1_vec = [0]
time_J_mu_vec = [1e5]
amp_ind_scale = 0.5  #   0.9667*0.92,     0.8197 #0.2 ### we measured J of 3.8765 for amplitude of 0.2 (including the Tpi relative calibration)
...
LS_vec_calib = (1e3)*np.array([0,-2,-1,0.2,1,1.3,1.3,1.3,1.6,2,2.9,2.9,2.9,2.3,0])
