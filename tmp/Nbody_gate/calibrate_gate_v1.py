...
T_pi_vec_microsec =  np.array([4.09,3.63,4.07])##np.array([4.101,3.486,4.061])##np.array([4.411,3.823,4.429])#this should be
...
if(scan_type=='Freq'):
    if((seq_type1=='Displacement')or(seq_type1=='Both') or(seq_type1=='Sqz_Clos')):
        w_k_disp_vec =  w_k_disp_vec+freq_offset+np.linspace(-2e2,2e2,11)#np.linspace(2.812e6,2.815e6,17)#np.linspace(2.79e6,2.83e6,15)#   np.linspace(2.8094e6,2.8098e6,15)
    elif((seq_type1=='Squeezing')):
