...
class BasicExperiment(artiq_env.EnvExperiment):
    """MW Rabi from Template.
    """

    _DATA_FOLDER = "mw_rabi"
    _APPLET_NAME = "MW Rabi"
    _APPLET_GROUP_NAME = "Rabi"
    _FIT_TYPE = fit.sin_fft
